...
namespace FAPS.Core.Model
{
    ...
    public class TransactionRequestResultData
    {
        ...
        public string partialId; //Order id for the partial sale action completed.
        public decimal originalFullAmount;
        public decimal partialAmountApproved;

        public string avsResponse; //Y
        public string cvv2Response;

        public string orderId; //Merchant set or newly generated by Gateway service.
        public string cardType;
        public string last4;
        public string maskedPan;
        public string token;

        public bool hasFee;                         // This should always be available

        private FeeResultData _fee = null;

        public FeeResultData fee
        {
            get
            {
                return _fee;
